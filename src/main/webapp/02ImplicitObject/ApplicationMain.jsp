...
<body>
	...
	하위에 프로젝트와 동잃나 환경을 만들어서 복사본 파일이 실행된다.
	...
	<%!
	/*
	선언분에서 내장객체를 바로 사용하는 건 불가능하다.
	내장객체는 _jspService() 메소드 내에서 생된 지역변수이므로 더 넓은 지역인
	선언부에서 사용하려면 매개변수로 전달받아야 한다.
	*/
	public String useImplicitObject() {
		/*
		방법 1 : getServletContext() 메소드를 통해 선언부에서 application
			내장객체를 얻어올 수 있다.
		*/
	...
	public String useImplicitObject(ServletContext app) {
		/*
		방법2 : 스트립트렛에서 메소드 호출 시 application 내장객체를 매개변수로
			전달해서 사용한다.
		*/

...
/*
	addDateHeader(헤더명, long타임의 타임스탬프)
	: 응답헤더 중 날짜를 추가하는 메서드로 세계표준시를 사용해서 설정한다.
	대한미국은 표준시 +09, 즉 9시간이 느리므로 9시간을 더해줘야 정상적인
...
//<form>태그를 통해 전송되는 모든 값은 문자열로 저장한다.
String add_str = request.getParameter("add_str");

 /*
 add계열의 메소드를 통해 응답헤더에 값을 추가한다.
...
<body>
    ...
    /*
    첫 번째 출력결과에서는 myNumber라는 헤더명이 2번 출력되는데 동일한 값이 출력된다.
    이것은 getHeader()ㅔㅁ소드의 특성으로 처음 입력값만 출력하게 된다.
    */
    %>
    ...
    정상적으로 출력된다. 즉 add계열의 메소드는 헤더명을 동일하게 사용하더라도
    헤더값은 정상적으로 추가된다.
    */
